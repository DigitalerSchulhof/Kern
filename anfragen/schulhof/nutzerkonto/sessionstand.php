...
// Timeout verlaengern
$verlaengern = [];
$sql = "SELECT sessiontimeout, {inaktivitaetszeit} FROM kern_nutzereinstellungen JOIN kern_nutzersessions ON kern_nutzereinstellungen.person = kern_nutzersessions.nutzer WHERE kern_nutzersessions.nutzer = ? AND sessionid = [?]";
