...
$formular[]  = new UI\FormularFeld(new UI\InhaltElement("Telefonnummer:"),         $schultele);
$formular[]  = new UI\FormularFeld(new UI\InhaltElement("Faxnummer:"),             $schulfax);
$formular[]  = new UI\FormularFeld(new UI\InhaltElement("eMail-Adresse:"),         $schulmail);
...
$formular[]  = new UI\FormularFeld(new UI\InhaltElement("Webmaster Name:"),        $webmleitname);
$formular[]  = new UI\FormularFeld(new UI\InhaltElement("Webmaster eMail:"),       $webmleitmail);
$formular[]  = new UI\FormularFeld(new UI\InhaltElement("Administration Name:"),   $admileitname);
$formular[]  = new UI\FormularFeld(new UI\InhaltElement("Administration eMail:"),  $admileitmail);
$formular[]  = (new UI\Knopf("Änderungen speichern", "Erfolg"))           ->setSubmit(true);
...
$formular[]   = new UI\FormularFeld(new UI\InhaltElement("Plain-Text Signatur:"),     $mailsignP);
$formular[]   = new UI\FormularFeld(new UI\InhaltElement("HTML Signatur:"),           $mailsignH);
$formular[]   = (new UI\Knopf("Änderungen speichern", "Erfolg"))                      ->setSubmit(true);
