...
$tabelle  = new UI\Tabelle("dshVerwaltungModuleInstalliert", "kern.schulhof.verwaltung.module.suchen", null, "Modul", "Beschreibung", "Autor", "Version");
...
if ($DSH_BENUTZER->hatRecht("module.installieren")) {
  ...
  $tabelle  = new UI\Tabelle("dshVerwaltungModuleVerfuegbar", "null", null, "Modul", "Beschreibung", "Autor", "Version");
  $tabelle  ->setAutoladen(true);
  $spalte[] = $tabelle;
}
