...
if ($DSH_BENUTZER->hatRecht("kern.personen.kurszuordnung.[|ausDatei,ausKlasse,zuruecksetzen]") && in_array("Gruppen", $vModule)) {
...
if ($DSH_BENUTZER->hatRecht("kern.personen.löschen.person") && in_array("Gruppen", $vModule)) {
