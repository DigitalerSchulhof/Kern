...
$formularpe[]  = new UI\FormularFeld(new UI\InhaltElement("Host:"),      $dbpehost);
$formularpe[]  = new UI\FormularFeld(new UI\InhaltElement("Port:"),      $dbpeport);
$formularpe[]  = new UI\FormularFeld(new UI\InhaltElement("Datenbank:"), $dbpedata);
$formularpe[]  = new UI\FormularFeld(new UI\InhaltElement("Benuzter:"),  $dbpeuser);
$formularpe[]  = (new UI\FormularFeld(new UI\InhaltElement("Passwort:"), $dbpepass))->setOptional(true);
$formularpe[]  = new UI\FormularFeld(new UI\InhaltElement("Schlüssel:"), $dbpeschl);
